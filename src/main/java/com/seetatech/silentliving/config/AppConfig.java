package com.seetatech.silentliving.config;


/**
 * Created by yummy on 17-12-7.
 */

public class AppConfig {

    public static final int MIN_FACE_SIZE = 80;
//    public static final int CAMERA_PREVIEW_WIDTH = 853;
    public static final int CAMERA_PREVIEW_WIDTH = 640;
//    public static final int CAMERA_PREVIEW_HEIGHT = 640;
